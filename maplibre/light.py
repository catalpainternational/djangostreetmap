...
class Light(BaseModel):
    ...
    color: str | None = Field(None, description="""Color tint for lighting extruded geometries.""")
    intensity: float | None = Field(None, description="""Intensity of lighting (on a scale from 0 to 1). Higher numbers will present as more extreme contrast.""")
